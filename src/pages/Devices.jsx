...
const Devices = () => {
  ...
  const handleImport = async (data, format) => {
    try {
      await deviceService.importDevices(data, format);
      fetchDevices();
                ...
                <tbody className="bg-white divide-y divide-gray-200">
                  {filteredDevices.map((device) => (
                    <tr key={device.id} className="hover:bg-gray-50">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{device.profile_name}</td>
                      <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{device.asset_name}</td>
