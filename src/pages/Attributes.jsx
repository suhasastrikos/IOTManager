    ...
    <div className="space-y-6">
      ...
      <div className="bg-white shadow rounded-lg">
        <div className="px-4 py-5 sm:p-6 text-center py-12">
          ...
          <h3 className="mt-2 text-sm font-medium text-gray-900">Attributes Management</h3>
          <p className="mt-1 text-sm text-gray-500">
            This page will allow you to manage static key-value attributes for your assets and devices.
          </p>
